...
import { Button, Icon } from '@tdesign/react';
  ...
  return (
    <>
      <PopConfirm content={$content} icon="success">
        <Button style={{ marginLeft: 8 }} theme="primary">使用String</Button>
      </PopConfirm>
      <PopConfirm content={$content} icon={iconComponent}>
        <Button style={{ marginLeft: 8 }} theme="primary">使用VNode</Button>
      </PopConfirm>
      <PopConfirm content={$content} icon={iconElement}>
        <Button style={{ marginLeft: 8 }} theme="primary">使用Function</Button>
      </PopConfirm>
    </>
  );
}
