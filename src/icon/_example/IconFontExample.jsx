import React from 'react';
  ...
  export default function IconFontExample() {
    return (
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="caret-down-small" size="2em" />
          <div style={{ marginTop: 12 }}>caret-down-small</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="caret-left-small" size="2em" />
          <div style={{ marginTop: 12 }}>caret-left-small</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="caret-right-small" size="2em" />
          <div style={{ marginTop: 12 }}>caret-right-small</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="caret-up-small" size="2em" />
          <div style={{ marginTop: 12 }}>caret-up-small</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="check-rectangle-filled" size="2em" />
          <div style={{ marginTop: 12 }}>check-rectangle-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="circle" size="2em" />
          <div style={{ marginTop: 12 }}>circle</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="clear" size="2em" />
          <div style={{ marginTop: 12 }}>clear</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="close-circle-filled" size="2em" />
          <div style={{ marginTop: 12 }}>close-circle-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="close-circle" size="2em" />
          <div style={{ marginTop: 12 }}>close-circle</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="close-rectangle" size="2em" />
          <div style={{ marginTop: 12 }}>close-rectangle</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="control-platform" size="2em" />
          <div style={{ marginTop: 12 }}>control-platform</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="dashboard" size="2em" />
          <div style={{ marginTop: 12 }}>dashboard</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="edit-1" size="2em" />
          <div style={{ marginTop: 12 }}>edit-1</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="filter-clear" size="2em" />
          <div style={{ marginTop: 12 }}>filter-clear</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="fullscreen-exit" size="2em" />
          <div style={{ marginTop: 12 }}>fullscreen-exit</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="fullscreen" size="2em" />
          <div style={{ marginTop: 12 }}>fullscreen</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logo-apple-filled" size="2em" />
          <div style={{ marginTop: 12 }}>logo-apple-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logo-chrome-filled" size="2em" />
          <div style={{ marginTop: 12 }}>logo-chrome-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logo-codepen" size="2em" />
          <div style={{ marginTop: 12 }}>logo-codepen</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logo-github-filled" size="2em" />
          <div style={{ marginTop: 12 }}>logo-github-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logo-ie-filled" size="2em" />
          <div style={{ marginTop: 12 }}>logo-ie-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logo-windows-filled" size="2em" />
          <div style={{ marginTop: 12 }}>logo-windows-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="logout" size="2em" />
          <div style={{ marginTop: 12 }}>logout</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="minus-circle-filled" size="2em" />
          <div style={{ marginTop: 12 }}>minus-circle-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="move" size="2em" />
          <div style={{ marginTop: 12 }}>move</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="pause-circle-filled" size="2em" />
          <div style={{ marginTop: 12 }}>pause-circle-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="play-circle-filled" size="2em" />
          <div style={{ marginTop: 12 }}>play-circle-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="play-circle-stroke" size="2em" />
          <div style={{ marginTop: 12 }}>play-circle-stroke</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="play" size="2em" />
          <div style={{ marginTop: 12 }}>play</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="precise-monitor" size="2em" />
          <div style={{ marginTop: 12 }}>precise-monitor</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="rectangle" size="2em" />
          <div style={{ marginTop: 12 }}>rectangle</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="root-list" size="2em" />
          <div style={{ marginTop: 12 }}>root-list</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="round" size="2em" />
          <div style={{ marginTop: 12 }}>round</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="stop-circle-1" size="2em" />
          <div style={{ marginTop: 12 }}>stop-circle-1</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="stop-circle-filled" size="2em" />
          <div style={{ marginTop: 12 }}>stop-circle-filled</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="user-circle" size="2em" />
          <div style={{ marginTop: 12 }}>user-circle</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <IconFont name="user-talk" size="2em" />
          <div style={{ marginTop: 12 }}>user-talk</div>
        </div>
      <div style={{ width: 140, height: 140, fontSize:'12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
