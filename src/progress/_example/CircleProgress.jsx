...
export default function LineProgress() {
  ...
  return (
    <div>
      ...
      <Progress theme={'circle'} size={340} strokeWidth={20} color={'#00f'} trackColor={'#0f0'} percentage={30}></Progress>
      <div style={style}>不显示数字</div>
      <Progress theme={'circle'} label={false}></Progress>
      <div style={style}>自定义内容</div>
      <Progress theme={'circle'} label={<div>75 day</div>}></Progress>
    </div>
  );
}
