    ...
    Array.isArray(options) && options.length > 0
      ...
      : React.Children.map(
          ...
          (child: React.JSX.Element) =>
            child?.type?.displayName === Checkbox.displayName && (child as ReactElement).props,
        ) || [];

  const optionsWithoutCheckAll = intervalOptions.filter((t) => typeof t !== 'object' || !(t as any).checkAll);
