...
visible | Boolean | false | 是否显示浮层。TS 类型：`boolean`。[详细类型定义](https://github.com/TDesignOteam/tdesign-react/blob/main/src/popup/type.ts) | N
defaultVisible | Boolean | false | 是否显示浮层。非受控属性。TS 类型：`boolean`。[详细类型定义](https://github.com/TDesignOteam/tdesign-react/blob/main/src/popup/type.ts) | N
