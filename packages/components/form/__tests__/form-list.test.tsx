...
describe('FormList', () => {
  ...
  describe('scenarios', () => {
    ...
    test('FormList with nested arrays', async () => {
      ...
      fireEvent.change(getInput('matrix-1-2'), {
        target: { value: 'm23-edit' },
      });
      await mockTimeout();
    ...
    test('FormList with shouldUpdate', async () => {
      ...
      const newWeightRadio = container.querySelector(
        '[data-route-index="2"] input[value="weight"]',
      ) as HTMLInputElement;
      ...
      const newAbtestRadio = container.querySelector(
        '[data-route-index="2"] input[value="abtest"]',
      ) as HTMLInputElement;
