...
export default function AnchorAttach() {
  ...
  return (
    <div>
      <div style={{ display: 'flex', flexDirection: 'column' }} id="attach" className="anchor-demo-attach">
        <div style={{ display: 'flex', gap: '20px' }}>
          ...
          >
            ...
            <AnchorItem href="#content-5" title="content-5" />
          </Anchor>
          <Anchor container="#anchor-container" onClick={handleClick} direction="vertical">
            <AnchorItem href="#content-1" title="content-1" />
            <AnchorItem href="#content-2" title="content-2" />
            <AnchorItem href="#content-3" title="content-3" />
            <AnchorItem href="#content-4" title="content-4" />
