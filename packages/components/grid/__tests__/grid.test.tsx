...
describe('Col', () => {
  describe('props', () => {
    test('Col flex', async () => {
      ...
      expect(container1.firstChild.firstChild).toHaveStyle({
        flex: '2 2 auto',
      });
      expect(container2.firstChild.firstChild).toHaveStyle({
        flex: '0 0 100px',
      });
      expect(container3.firstChild.firstChild).toHaveStyle({
        flexBasis: 'auto',
      });
    });
  });
