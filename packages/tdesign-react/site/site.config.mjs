    ...
    children: [
      {
        ...
        component: () => import('@/packages/tdesign-react/site/docs/getting-started.md'),
        componentEn: () => import('@/packages/tdesign-react/site/docs/getting-started.en-US.md'),
      },
      {
        title: '最佳实践',
        titleEn: 'Starter Kit',
        ...
        component: () => import('@/packages/tdesign-react/site/docs/starter.md'),
        componentEn: () => import('@/packages/tdesign-react/site/docs/starter.en-US.md'),
      },
      {
        title: '更新日志',
        titleEn: 'CHANGELOG',
        ...
        component: () => import('@/packages/tdesign-react/CHANGELOG.md'),
      },
      {
        title: '组件概览',
        titleEn: 'Overview',
