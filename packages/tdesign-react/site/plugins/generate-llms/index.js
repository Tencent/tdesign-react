 ...
 * 此处仅负责 vite 构建钩子分发，并按 React 仓库约定注入组件文档与 demo 源码读取器。
 */
export default function generateLlms() {
  ...
  return {
    ...
    async closeBundle(error) {
      ...
      // common 子仓文档根目录（组件文档为 <slug>.md，如 packages/common/docs/web/api/button.md）
      ...
      await generateLlmsDocs({
        ...
        siteDescription: 'TDesign 适配桌面端的组件库，适合在 React 技术栈项目中使用。',
