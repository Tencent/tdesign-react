...
import { ActionProvider, DataProvider, VisibilityProvider } from '../contexts';
 ...
 */
export const JsonRenderActivityRenderer = React.memo(JsonRenderActivityRendererInner, (prevProps, nextProps) => {
  // registry 变化必须重渲染
