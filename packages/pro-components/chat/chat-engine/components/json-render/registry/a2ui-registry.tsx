 ...
 */
const BaseInput: React.FC<InputProps & { label?: string }> = ({ label, ...props }) => {
  if (label) {
    return (
 ...
 */
const BaseButton: React.FC<ButtonProps & { label?: string }> = ({ label, children, ...props }) => {
 ...
 */
export const A2UITextField = withA2UIBinding<InputProps & { label?: string }>(BaseInput, {
  valueField: 'value',
