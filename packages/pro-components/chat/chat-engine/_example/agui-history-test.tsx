...
import { AGUIAdapter } from '@tdesign/web-components-chat/lib/chat-engine';
import type { AGUIHistoryMessage, AGUIActivityMessage } from '@tdesign/web-components-chat/lib/chat-engine';
