        ...
        children: [
          {
            title: 'Addon 附加',
            name: 'addon',
            path: '/react/components/addon',
            component: () => import('@tencent/tdesign-react/addon/README.md'),
          },
          {
            title: 'InputGrout 输入框组',
            name: 'input-group',
            path: '/react/components/input-group',
            component: () => import('@tencent/tdesign-react/input-group/README.md'),
          },
        ],
      },
    ],
